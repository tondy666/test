...
import Tondy
from Tondy.lib.curve.ttypes import *
...
cl = Tondy.LINE()
cl.login(token="u863d40a4e52e84e8f64ce1198474d648:uGgbMuNZ5AwK2AnWcJkj")
cl.loginResult()

cl

print "BOT By Tondy_666"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""_________________________________

Bot Publik  Tondy_666
========Menu Bot=========
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"BOT By Tondy_666",
    "lang":"JP",
    "comment":"BOT By Tondy_666",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
